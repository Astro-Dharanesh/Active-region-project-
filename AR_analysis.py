...
AIA_DATA=Fido.search(a.Time('2020/11/11 00:00:00','2020/11/11 00:00:10'),a.Instrument.aia, a.Wavelength(193*u.angstrom),a.Physobs.intensity)

AIA_DATA

AIA_files = Fido.fetch(AIA_DATA)

"""Check files and their locations"""
...
HMI_DATA=Fido.search(a.Time('2020/11/11 00:00:00','2020/11/11 00:00:40'),a.Instrument.hmi, a.Physobs.los_magnetic_field)

HMI_DATA

HMI_files=Fido.fetch(HMI_DATA)

HMI_files

hmi6163 = sunpy.map.Map(HMI_files) #you wrote hmi data instead of HMI_files need to correct here...

hmi6163.meta #meta provide the information of the data
...
aia_bottom_left = SkyCoord(235 * u.arcsec, -340 * u.arcsec, frame=aia_reprojected.coordinate_frame)
aia_top_right = SkyCoord(435 * u.arcsec, -500 * u.arcsec, frame=aia_reprojected.coordinate_frame)
